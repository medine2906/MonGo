...
export interface MonecoTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "TOTAL_SUPPLY"
      | "allowance"
...
export interface MonecoToken extends BaseContract {
  connect(runner?: ContractRunner | null): MonecoToken;
  waitForDeployment(): Promise<this>;

  interface: MonecoTokenInterface;
